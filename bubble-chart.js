...
var width = document.getElementById("bubble-chart").offsetWidth * 0.8 - margin.left - margin.right;
var height = document.getElementById("bubble-chart").offsetHeight * 0.8 - margin.top - margin.bottom;
